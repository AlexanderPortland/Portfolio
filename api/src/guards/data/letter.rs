...
//
pub struct Letter<P: FrontendPolicy + FoldInAllowed>(BBox<Vec<u8>, P>);

impl<P: FrontendPolicy + FoldInAllowed> Into<BBox<Vec<u8>, P>> for Letter<P> {
...
#[rocket::async_trait]
impl<'a, 'r, P: FrontendPolicy + FoldInAllowed> FromBBoxData<'a, 'r> for Letter<P> {

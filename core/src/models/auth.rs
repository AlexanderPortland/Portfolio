...
pub trait AuthenticableTrait {
    type User;
    type Session;
    async fn login(db: &DbConn, user: BBox<i32, FakePolicy>, password: BBox<String, FakePolicy>, ip_addr: BBox<String, FakePolicy>) -> Result<(BBox<String, FakePolicy>, BBox<String, FakePolicy>), ServiceError>;

...
impl TryFrom<(BBox<i32, NoPolicy>, ApplicationDetails)> for ApplicationRow {
    ...
    fn try_from((application, d): (BBox<i32, NoPolicy>, ApplicationDetails)) -> Result<Self, ServiceError> {
        ...
        Ok(Self {
            ...
            birth_surname: BBox::new(Some(c.birthSurname.discard_box()), NoPolicy::new()),
            ...
            letter_address: BBox::new(Some(c.letterAddress.discard_box()), NoPolicy::new()),
            ...
            personal_identification_number: BBox::new(Some(c.personalIdNumber.discard_box()), NoPolicy::new()),
            health_insurance: BBox::new(Some(c.healthInsurance.discard_box()), NoPolicy::new()),
            school_name: BBox::new(Some(c.schoolName.discard_box()), NoPolicy::new()),
            ...
            first_school_name: BBox::new(Some(c.firstSchool.clone().discard_box().name().to_owned()), NoPolicy::new()),
            first_school_field: BBox::new(Some(c.firstSchool.clone().discard_box().field().to_owned()), NoPolicy::new()),
            second_school_name: BBox::new(Some(c.secondSchool.clone().discard_box().name().to_owned()), NoPolicy::new()),
            second_school_field: BBox::new(Some(c.secondSchool.clone().discard_box().field().to_owned()), NoPolicy::new()),
    ...
    async fn export(context: Context<ContextDataType>, db: &DbConn, private_key: BBox<String, NoPolicy>) -> Result<BBox<Vec<u8>, NoPolicy>, ServiceError> {
        ...
        for model in candidates {
            ...
            let (first_field, second_field) = (
                get_our_school_field(&c.firstSchool.clone().discard_box()).map_err(|_| ServiceError::InvalidFieldOfStudy)?,
                get_our_school_field(&c.secondSchool.clone().discard_box()).map_err(|_| ServiceError::InvalidFieldOfStudy)?,
            );
            ...
            let row = CandidateRow {
                ...
                first_school: BBox::new(c.firstSchool.clone().discard_box().name().to_string(), NoPolicy::new()),
                first_school_field: BBox::new(c.firstSchool.clone().discard_box().field().to_string(), NoPolicy::new()),
                second_school: BBox::new(c.secondSchool.clone().discard_box().name().to_string(), NoPolicy::new()),
                second_school_field: BBox::new(c.secondSchool.clone().discard_box().field().to_string(), NoPolicy::new()),
